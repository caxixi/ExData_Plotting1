...
#a. transforming the Date and Time columns to
#charachter collums
HPC2d$Date<-as.character(HPC2d$Date)
HPC2d$Time<-as.character(HPC2d$Time)

#b. creating a ew column that combine the two 
...
#plot:
hist(HPC2days$Global_active_power, col="red", xlab="Global Active Power (killowats)", main="Global Active Power")
